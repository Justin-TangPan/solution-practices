# Headroom + Claude Code — AI 编程上下文压缩 一键部署
...
- **AST 感知** — 支持 Python、JS、Go、Rust、Java、C++ 语法树级智能压缩
...
| Flexus 云服务器 X 实例 | headroom-claude-code-ecs | 0.32 元/小时，2 核 4GB，Ubuntu 24.04，40GB 高 IO | 1 | ≈233.60 元 |
