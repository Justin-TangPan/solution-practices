...
variable "ecs_flavor" {
  default     = "x1.8u.16g"
  description = "ECS instance flavor. x1.8u.16g (8vCPUs 16GiB) recommended."
  type        = string
  nullable    = false
  validation {
...
variable "system_disk_size" {
  default     = 100
  description = "System disk size (GB), range: 40-1024. Default: 100."
  type        = number
  nullable    = false
  validation {
...
resource "huaweicloud_compute_instance" "compute_instance" {
  ...
  user_data = "#!/bin/bash\necho 'root:${var.ecs_password}' | chpasswd\nwget -P /home/ ${var.obs_base_url}/aitoearn/intl/ap-southeast-3/standard/install_aitoearn.sh\nbash /home/install_aitoearn.sh\nrm -rf /home/install_aitoearn.sh"
}
