...
| **sac-script-builder** | 生成 Terraform HCL、内联 user_data、Docker Compose 配置 | resource-plan.yaml + 应用配置 | deploying-*.tf + .extension |
| **sac-doc-writer** | 生成部署指南 + 方案详情 + .extension + SAC 报告 | technical-evaluation.md + 模板清单 | 部署指南_zh / 方案详情_zh / Deployment-Guide_en / Solution-Details_en + .extension + SAC-*.md/.docx |
...
├── terraform/
│   └── deploying-{solution-name}.tf    # 基础架构即代码 + 内联 user_data
└── docs/
    ├── {SolutionName}-部署指南_zh.md       # 中文部署指南
    ├── {SolutionName}-方案详情_zh.md       # 中文方案详情
    ├── {SolutionName}-Deployment-Guide_en.md # 英文部署指南
    ├── {SolutionName}-Solution-Details_en.md # 英文方案详情
...
├── .extension                    ← RFS 参数配置
├── terraform/
│   └── deploying-headroom.tf     ← VPC + ECS + EIP + SG + 内联 user_data
└── docs/
    ├── Headroom-部署指南_zh.md
    └── Headroom-方案详情_zh.md
```
...
├── scripts/
│   └── deploying-litellm.tf        ← 内联生成 Compose、配置和健康检查
└── docs/
    ├── LiteLLM-部署指南_zh.md      ← 中文部署指南
    └── LiteLLM-方案详情_zh.md      ← 中文方案详情
```
