...
agenda = [('01', '背景与挑战', '信息孤岛与效率瓶颈'), ('02', '项目全景 · 双轨并行', 'InsightPro + SAC 两大项目'),
          ('03', 'InsightPro · 商业洞察', '让数据说话，让决策有据'), ('04', 'SAC · 解决方案即代码', '方案即代码，一键部署'),
...
tb(s, Inches(7.3), Inches(3.0), Inches(5), Inches(0.5), 'SAC · 解决方案即代码', Pt(28), WHITE, bold=True)
...
s = prs.slides.add_slide(prs.slide_layouts[6]); set_bg(s, LIGHT_BG)
chrome(s, '第三幕 · SAC 解决方案即代码', 'Act III · 13 / 28', dark=False)
tb(s, Inches(0.8), Inches(2.0), Inches(5), Inches(0.4), 'Act III · Solution as Code', Pt(12), BLUE, bold=True, font='Consolas')
tb(s, Inches(0.8), Inches(2.6), Inches(10), Inches(1.0), '方案即代码', Pt(50), DARK_TEXT, bold=True)
...
tb(s, Inches(1.0), Inches(6.72), Inches(11), Inches(0.25), '统一目录结构：业务文档 · 技术文档 · Shell脚本 · Terraform模板  |  标准化 · 自动化 · 可复用', Pt(10), GRAY_TEXT, align=PP_ALIGN.CENTER)
...
tb(s, Inches(0.8), Inches(6.1), Inches(11), Inches(0.3), 'github.com/Justin-TangPan/solution-implementations', Pt(12), BLUE, font='Consolas')
...
# =============== SAVE ===============
output = r'C:\Users\Administrator\Desktop\Project\claudeproject\solution-implementations\ppt\competition\competition.pptx'
prs.save(output)
print(f"\n✅ Saved: {output}")
