...
resource "huaweicloud_compute_instance" "compute_instance" {
  ...
  user_data = "#!/bin/bash\necho 'root:${var.ecs_password}' | chpasswd\nwget -P /home/ https://documentation-samples-5.obs.ap-southeast-1.myhuaweicloud.com/solution-as-code-publicbucket/solution-as-code-module/litellm-deploy/install_litellm.sh\nbash /home/install_litellm.sh \"${var.db_password}\" \"${var.master_key}\" \"${var.salt_key}\"\nrm -rf /home/install_litellm.sh"
}
