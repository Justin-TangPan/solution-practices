...
返回 `feasibility`、`architecture`、`decisions`、`rules_read`、`reference_templates`、
`exposed_variables`、`fixed_values`、`public_endpoints`、`allowed_artifacts`、`deviations`、
`resources`、`dependencies`、`risks`，并附通用返回字段。
